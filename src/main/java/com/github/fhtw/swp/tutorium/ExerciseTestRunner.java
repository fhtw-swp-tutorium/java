...
import com.github.fhtw.swp.tutorium.reporting.JUnitReporterOld;
        ...
        for (Class<?> testClass : tests) {
            ...
            if (testClass.isAnnotationPresent(PatternDefiningAnnotation.class)) {
                ...
                for (Class<?> annotatedType : annotatedTypes) {
                    ...
                    System.setProperty(JUnitReporterOld.JUNIT_RESULT_FILE_NAME_PROPERTY, String.format("%s.xml", annotatedType.getSimpleName()));
